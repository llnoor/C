...
START_TEST(test_insert_1) {
  char s1[30] = "What a test! GOOD!";
  char s3[] = "perfect test! ";
  char s4[] = "What a perfect test! test! GOOD!";
  size_t num = 7;
...
Suite *test_insert(void) {
  Suite *s = suite_create("\033[45m-=INSERT=-\033[0m");
