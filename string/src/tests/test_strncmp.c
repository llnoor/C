...
START_TEST(strncmp_1) {
  char s1[] = "Goodbuy my friend! Have a nice day!";
  char s2[] = "Goodbuy my friend! Have a nice day!";
  size_t n = 14;
...
START_TEST(strncmp_2) {
  char s1[] = "Goodbuy my friend! Have a nice day!";
  char s2[] = "Goodbuy my friend! Have a nice dayj";
  size_t n = 14;
  int n1 = strncmp(s1, s2, n);
  n1 = n1 > 0 ? 1 : n1 == 0 ? 0 : -1;
  int n2 = strncmp(s1, s2, n);
...
Suite *test_strncmp(void) {
  Suite *s = suite_create("\033[45m-=STRNCMP=-\033[0m");
