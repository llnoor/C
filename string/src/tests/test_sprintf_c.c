...
/*START_TEST(sprintf_20_c) {
  ...
  int a = 266;
  ck_assert_int_eq(sprintf(str1, str3, a), sprintf(str2, str3, a));
  ck_assert_pstr_eq(str1, str2);
  // sprintf(str1, str3, a);
  //                  sprintf(str2, str3, a);
...
Suite *test_sprintf_c(void) {
  Suite *s = suite_create("\033[45m-=SPRINTF_C=-\033[0m");
