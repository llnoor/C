...
START_TEST(test_is_less_or_equal_4) {
  decimal a = {{U_MAX_INT, 0, 0, 0}};
  decimal b = {{U_MAX_INT, 1, 0, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST

START_TEST(test_is_less_or_equal_41) {
  decimal a = {{U_MAX_INT, 1, 0, 0}};
  decimal b = {{U_MAX_INT, 1, 0, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST
...
START_TEST(test_is_less_or_equal_5) {
  decimal a = {{U_MAX_INT, U_MAX_INT - 1, 0, 0}};
  decimal b = {{U_MAX_INT, U_MAX_INT, 0, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST

// START_TEST(test_is_less_or_equal_51) {
//     decimal a = {{U_MAX_INT, U_MAX_INT, 0, 0}};
//     decimal b = {{U_MAX_INT, U_MAX_INT, 0, 0}};
//     ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
// }
END_TEST
...
START_TEST(test_is_less_or_equal_6) {
  decimal a = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, 0}};
  decimal b = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST

START_TEST(test_is_less_or_equal_7) {
  decimal a = {{U_MAX_INT, U_MAX_INT, U_MAX_INT - 1, 0}};
  decimal b = {{U_MAX_INT, U_MAX_INT, U_MAX_INT, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST
...
START_TEST(test_is_less_or_equal_8) {
  decimal a = {{0, U_MAX_INT, U_MAX_INT, 0}};
  decimal b = {{0, U_MAX_INT, U_MAX_INT, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST

START_TEST(test_is_less_or_equal_9) {
  decimal a = {{0, 0, U_MAX_INT, 0}};
  decimal b = {{0, 0, U_MAX_INT, 0}};
  ck_assert_int_eq(is_less_or_equal(a, b), TRUE);
}
END_TEST
