...
START_TEST(strncat_1) {
  ...
  size_t n = 1;
  ck_assert_pstr_eq(strncat(s1, s3, n), strncat(s2, s3, n));
}
END_TEST
...
START_TEST(strncat_15) {
  char s1[100] = "Goodbuy my friend! Have a nice day!\0\0\0";
  char s2[100] = "Goodbuy my friend! Have a nice day!\0\0\0";
  char s3[] = "OK!!! THANKS!!!";
  size_t n = 0;
  ck_assert_pstr_eq(strncat(s1, s3, n), strncat(s2, s3, n));
}
...
Suite *test_strncat(void) {
  Suite *s = suite_create("\033[45m-=STRNCAT=-\033[0m");
