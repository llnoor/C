...
START_TEST(sprintf_1_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val), sprintf(str2, str3, val));
...
START_TEST(sprintf_2_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val3),
                   sprintf(str2, str3, val, val2, val3));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_6_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val3, val4),
                   sprintf(str2, str3, val, val2, val3, val4));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_8_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val3, val4, val5),
                   sprintf(str2, str3, val, val2, val3, val4, val5));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_15_string) {
  ...
  ck_assert_int_eq(
      ...
      sprintf(str2, str3, ast, val, ast2, val2, ast3, ast4, val3, ast5,
                  val4));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_16_string) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, val2, val4, val3),
                   sprintf(str2, str3, val, val2, val4, val3));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
START_TEST(sprintf_17_string) {
  ...
  char *val = NULL;
  sprintf(str2, str3, val, val, val, val, val, val, val, val, val, val, val,
              val);
...
Suite *test_sprintf_string(void) {
  Suite *s = suite_create("\033[45m-=SPRINTF_STRING=-\033[0m");
