...
START_TEST(sprintf_2_n) {
  ...
  ck_assert_int_eq(sprintf(str1, str3, val, &valn1, val2, &valn3),
                   sprintf(str2, str3, val, &valn2, val2, &valn4));
  ck_assert_pstr_eq(str1, str2);
  ck_assert_int_eq(valn1, valn2);
...
//                    sprintf(str2, str3, val, val2, &valn2, val3));
//   ck_assert_pstr_eq(str1, str2);
//   ck_assert_int_eq(valn1, valn2);
// }
// END_TEST
...
//       sprintf(str2, str3, val, val2, (unsigned short)val3, &valn2));
//   ck_assert_pstr_eq(str1, str2);
//   ck_assert_int_eq(valn1, valn2);
// }
// END_TEST
...
Suite *test_sprintf_n(void) {
  Suite *s = suite_create("\033[45m-=SPRINTF_N=-\033[0m");
