...
START_TEST(test_is_greater_2) {
  ...
  decimal b = {{0, 0, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST

START_TEST(test_is_greater_2i) {
  decimal a = {{MAX_UINT, 0, 0, 0}};
  decimal b = {{MAX_UINT - 1, 0, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST
...
START_TEST(test_is_greater_3) {
  decimal a = {{MAX_UINT, 0, 0, 0}};
  decimal b = {{MAX_UINT, 0, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), FALSE);
}
END_TEST

START_TEST(test_is_greater_4) {
  decimal a = {{MAX_UINT, 0, 0, 0}};
  decimal b = {{MAX_UINT, 1, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), FALSE);
}
END_TEST

START_TEST(test_is_greater_41) {
  decimal a = {{MAX_UINT, 1, 0, 0}};
  decimal b = {{MAX_UINT, 0, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST
...
START_TEST(test_is_greater_5) {
  ...
  decimal b = {{MAX_UINT, MAX_UINT - 1, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST
...
START_TEST(test_is_greater_51) {
  decimal a = {{MAX_UINT, MAX_UINT, 0, 0}};
  decimal b = {{MAX_UINT, MAX_UINT, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), FALSE);
}
END_TEST
...
START_TEST(test_is_greater_6) {
  ...
  decimal b = {{MAX_UINT, MAX_UINT, MAX_UINT - 1, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST

START_TEST(test_is_greater_7) {
  decimal a = {{MAX_UINT, MAX_UINT, MAX_UINT - 1, 0}};
  decimal b = {{MAX_UINT, MAX_UINT, 0, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST
...
START_TEST(test_is_greater_8) {
  decimal a = {{0, MAX_UINT, MAX_UINT, 0}};
  decimal b = {{0, MAX_UINT, MAX_UINT - 1, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST

START_TEST(test_is_greater_9) {
  decimal a = {{0, 0, MAX_UINT, 0}};
  decimal b = {{0, 0, MAX_UINT - 1, 0}};
  ck_assert_int_eq(is_greater(a, b), TRUE);
}
END_TEST
...
Suite *test_is_greater(void) {
  ...
  tcase_add_test(tc, is_greaterTest17);
  ...
  tcase_add_test(tc, is_greaterTest35);
  ...
  tcase_add_test(tc, test_is_greater_2i);
