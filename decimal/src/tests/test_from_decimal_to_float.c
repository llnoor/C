...
START_TEST(from_decimal_to_float_6) {
  ...
  // ставим знак
  negate(dec, &dec);
  result = from_decimal_to_float(dec, &number);
  ck_assert_float_eq(number, -18.122);
  ck_assert_int_eq(result, 0);
}
END_TEST
...
START_TEST(from_decimal_to_floatTest1) {
  // 6997
  decimal src1;
  ...
  from_decimal_to_float(src1, srcp);
  char var3str[1000];
  char result[1000];
...
START_TEST(from_decimal_to_floatTest2) {
  // 7016
  decimal src1;

  float src2;
  float *srcp = &src2;
  // decimal src1 = -0.46453;
...
START_TEST(from_decimal_to_floatTest3) {
  // 7035
  decimal src1;
...
START_TEST(from_decimal_to_floatTest4) {
  // 7054
  decimal src1;
...
START_TEST(from_decimal_to_floatTest5) {
  // 7073
  decimal src1;
...
START_TEST(from_decimal_to_floatTest6) {
  // 7092
  decimal src1;

  float src2;
  float *srcp = &src2;
  // decimal src1 = -5.49265;
...
START_TEST(from_decimal_to_floatTest7) {
  // 7111
  decimal src1;

  float src2;
  float *srcp = &src2;
  // decimal src1 = 2.5086531268974139743;
...
Suite *test_from_decimal_to_float(void) {
  ...
  tcase_add_test(tc, from_decimal_to_floatTest1);
  tcase_add_test(tc, from_decimal_to_floatTest2);
  tcase_add_test(tc, from_decimal_to_floatTest3);
  tcase_add_test(tc, from_decimal_to_floatTest4);
  tcase_add_test(tc, from_decimal_to_floatTest5);
  tcase_add_test(tc, from_decimal_to_floatTest6);
  tcase_add_test(tc, from_decimal_to_floatTest7);  //  infinite loop
